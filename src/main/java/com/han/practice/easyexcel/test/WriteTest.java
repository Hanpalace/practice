package com.han.practice.easyexcel.test;
...
import com.han.practice.easyexcel.dto.*;
import com.han.practice.easyexcel.handler.CommentWriteHandler;
import com.han.practice.easyexcel.handler.CustomCellWriteHandler;
import com.han.practice.easyexcel.handler.CustomSheetWriteHandler;
import com.han.practice.utils.TestFileUtil;
    ...
    public void imageWrite() throws Exception {
        ...
        try (InputStream inputStream = FileUtils.openInputStream(new File(imagePath))) {
            ...
            imageDemoData.setUrl(new URL(
                "https://github.com/alibaba/easyexcel/blob/master/easyexcel-test/src/test/resources/converter/img.jpg"));
